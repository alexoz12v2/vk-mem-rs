...
impl Allocator {
  ...
  pub unsafe fn new(create_info: AllocatorCreateInfo) -> VkResult<Self> {
    ...
    let mut raw_create_info = ffi::VmaAllocatorCreateInfo {
      ...
      pTypeExternalMemoryHandleTypes: if create_info.type_external_memory_handle_types.is_empty() {
        core::ptr::null()
      } else {
    ...
    let routed_functions = ffi::VmaVulkanFunctions {
      ...
      vkInvalidateMappedMemoryRanges: create_info.device.fp_v1_0().invalidate_mapped_memory_ranges,
      ...
      vkGetImageMemoryRequirements2KHR: create_info.device.fp_v1_1().get_image_memory_requirements2,
  ...
  pub unsafe fn get_physical_device_properties(&self) -> VkResult<vk::PhysicalDeviceProperties> {
    ...
    ffi::vmaGetPhysicalDeviceProperties(self.internal, &mut properties as *mut _ as *mut *const _);
  ...
  pub fn calculate_statistics(&self) -> VkResult<ffi::VmaTotalStatistics> {
    unsafe {
      let mut vma_stats: ffi::VmaTotalStatistics = core::mem::zeroed();
  ...
  /// become outdated.
  pub fn get_heap_budgets(&self) -> VkResult<alloc::vec::Vec<ffi::VmaBudget>> {
    unsafe {
      let len = self.get_memory_properties().memory_heap_count as usize;
      let mut vma_budgets: alloc::vec::Vec<ffi::VmaBudget> = alloc::vec::Vec::with_capacity(len);
  ...
  pub fn get_allocation_info2(&self, allocation: &Allocation) -> AllocationInfo2 {
    unsafe {
      let mut allocation_info: ffi::VmaAllocationInfo2 = core::mem::zeroed();
  ...
  pub unsafe fn copy_allocation_to_memory(
    ...
    ffi::vmaCopyAllocationToMemory(
      ...
      dst_ref.as_mut_ptr() as *mut core::ffi::c_void,
  ...
  pub unsafe fn flush_allocations<'a>(
    ...
    let allocations: alloc::vec::Vec<ffi::VmaAllocation> =
      allocations.into_iter().map(|a| a.0).collect();
    ffi::vmaFlushAllocations(
      self.internal,
      allocations.len() as u32,
      allocations.as_ptr() as *mut _,
      offsets.map_or(core::ptr::null(), |offsets| offsets.as_ptr()),
